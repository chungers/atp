...
template <typename ContractBasedRequest>
bool marshall(ContractBasedRequest& mdr, List& rList)
{
...
template <typename ContractBasedCancel>
bool marshallCancel(ContractBasedCancel& cmdr, List& rList)
{
...
SEXP firehose_marketohlc(SEXP handle, SEXP list)
{
  List handleList(handle);
  XPtr<zmq::socket_t> socket(handleList["socket"], R_NilValue, R_NilValue);
...
SEXP firehose_cancel_marketohlc(SEXP handle, SEXP list)
{
  List handleList(handle);
  XPtr<zmq::socket_t> socket(handleList["socket"], R_NilValue, R_NilValue);
