...
// CouchDB
#define COUCHDB_LOGGER VLOG(40)
#define COUCHDB_DEBUG VLOG(50)
#define COUCHDB_ERROR LOG(ERROR)
...
// ContractManager
#define CONTRACT_MANAGER_LOGGER VLOG(10)
#define CONTRACT_MANAGER_DEBUG VLOG(20)
#define CONTRACT_MANAGER_WARNING LOG(WARNING)
#define CONTRACT_MANAGER_ERROR LOG(ERROR)

#define MOVING_WINDOW_ERROR LOG(ERROR)
